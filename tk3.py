...
class A:
    ...
    def createpage(self):
        ...
        self.frmMain.config(bg='blue', height=500, width=600)
        Label(self.frmMain, text='frmMain').place(in_=self.frmMain, anchor=NW)
        self.frmMain.place(x=180, y=50)
        ...
        # frmMain下的控件
        Label(self.frmMain, text='项目资源管理平台',
              fg='red', font='Verdana 10 bold').place(x=100, y=50, height=80, width=400)
        Button(self.frmMain, text='1', height=1, width=1).place(x=450, y=450)
        Button(self.frmMain, text='2', height=1, width=1).place(x=490, y=450)
        Button(self.frmMain, text='3', height=1, width=1).place(x=530, y=450)
